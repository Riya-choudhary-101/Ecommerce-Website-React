...
mongoose.connect("mongodb+srv://Riya:mong56data@ecommerce-cluster.lelthuy.mongodb.net/Ecommerce");
...
app.post("/upload",upload.single('product'),(req,res)=>{
    ...
    //         success: 0,
    //         message: "No file uploaded. Check if key name is 'product' and a file is selected."
    //     });
    // }
...
// Schema creatinng for uuser model
...
// creating endpoint adding products in cart data
